...
module Spree
  module BaseHelper
    ...
    def taxon_breadcrumbs(taxon, separator = '', _breadcrumb_class = nil)
      ...
      content_tag(:nav, content_tag(:ul, raw(items.map(&:mb_chars).join), itemscope: '', itemtype: 'https://schema.org/BreadcrumbList'), id: 'breadcrumbs', class: 'breadcrumb')
    end
